...
>This role was originally pulled from galaxy author: DAUPHANT Julien 
...
6. Example to use this role with an ssl-certs role to generate or copy ssl certificate (https://galaxy.ansible.com/list#/roles/3115 )
```yaml
 - hosts: all
   roles: 
     - jdauphant.ssl-certs
